...
<html lang="fr" class="h-full">
    ...
    <body class="min-h-full antialiased">
        <div class="pointer-events-none fixed inset-0 overflow-hidden" aria-hidden="true">
            <div class="absolute -left-32 top-0 h-[28rem] w-[28rem] rounded-full bg-violet-400/25 blur-[100px]"></div>
            <div class="absolute -right-24 top-1/3 h-80 w-80 rounded-full bg-cyan-400/20 blur-[90px]"></div>
